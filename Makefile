...
generate-playbook:
	...
	@echo "  vars:" >> $(PLAYBOOK)
	@echo "    node_exporter_tls_server_config:" >> $(PLAYBOOK)
	@echo "      cert_file: /etc/node_exporter/tls.cert" >> $(PLAYBOOK)
	@echo "      key_file: /etc/node_exporter/tls.key" >> $(PLAYBOOK)
	@echo "    node_exporter_basic_auth_users:" >> $(PLAYBOOK)
	@echo "      randomuser: examplepassword" >> $(PLAYBOOK)
	@echo "  roles:" >> $(PLAYBOOK)
	@echo "    - role" >> $(PLAYBOOK)
